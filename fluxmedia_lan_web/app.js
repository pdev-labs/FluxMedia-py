...
function openInVLC(file) {
  ...
  if (navigator.clipboard && window.isSecureContext) {
    navigator.clipboard.writeText(fullUrl)
      .then(() => showToast('VLC playlist downloaded & stream URL copied! Open the .m3u file in VLC.'))
      .catch(() => showToast('VLC playlist downloaded! Open the .m3u file in VLC → Media → Open.'));
  } else {
    showToast('VLC playlist downloaded! Open the .m3u file in VLC → Media → Open.');
  }
}
